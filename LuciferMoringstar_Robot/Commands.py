    ...
    if usr_cmdall1.startswith("/start pr0fess0r_99"):
            ...
            try:
                ...
                await bot.send_message(
                    ...
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
                                InlineKeyboardButton('CC Group🎬', url="https://t.me/cv_movies")
                            ],
                            [
                                InlineKeyboardButton('Movie Linkz', url="https://t.me/cc_linkz")
                            ]
                        ]
                    ),
                    parse_mode="markdown"
        ...
        try:
            ...
            for files in filedetails:
                ...
                buttons = [
                    ...
                    [
                        InlineKeyboardButton('HarshadM',url=https://t.me/Harshad_Scam")
                    ]
                    ]
        ...
        await bot.send_message(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("For Queries", url="https://t.me/Harshad_Scam")
                    ]
                ]
            )
        )
        ...
        await message.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[
                InlineKeyboardButton("Join Group✔️", url="https://t.me/Cv_movies")
                ]
            )
        )
        StopPropagation
...
async def bot_info(bot, message):
    buttons = [
        [
            InlineKeyboardButton('Join CC Group', url='https://t.me/cv_movies'),
            InlineKeyboardButton('CC Channels', url='https://t.me/cc_channels')
        ]
        ]
